...
namespace Canchas.Api.Controllers
{
    ...
    public class DashboardController : ControllerBase
    {
        ...
        public async Task<IActionResult> Resumen([FromQuery] DateTime? fecha)
        {
            ...
            var reservadas = await reservaciones
                .CountAsync(r =>
                    r.EstadoReservacion.Nombre == "RESERVADA");

            var utilizadas = await reservaciones
                .CountAsync(r =>
                    r.EstadoReservacion.Nombre == "UTILIZADA");

            var canceladas = await reservaciones
                .CountAsync(r =>
                    r.EstadoReservacion.Nombre == "CANCELADA");

            var ingresos = await reservaciones
                .Where(r =>
                    r.EstadoReservacion.Nombre != "CANCELADA")
            ...
            {
                Fecha = fechaConsulta,
                CanchasActivas = await _context.Canchas
