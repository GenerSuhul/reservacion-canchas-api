...
namespace Canchas.Api.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post(UsuarioCrearDto dto)
        {
            ...
            var nombreRol = dto.Rol.Trim().ToUpperInvariant();
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Put(int id, UsuarioActualizarDto dto)
        {
            ...
            var tieneRol = usuario.UsuarioRoles.Any(ur => ur.IdRol == rol.IdRol);
        ...
        public async Task<IActionResult> CambiarPassword(int id, UsuarioPasswordDto dto)
        {
