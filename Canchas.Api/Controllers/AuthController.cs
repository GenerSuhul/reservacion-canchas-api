...
namespace Canchas.Api.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(CanchasDbContext context, TokenService tokenService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Login(LoginRequestDto request)
        {
            ...
            if (!BCrypt.Net.BCrypt.Verify(request.Password, usuario.PasswordHash))
            {
                ...
                if (usuario.IntentosFallidos >= 5)
                {
                    ...
                    return StatusCode(423, new
                    {
                        mensaje = "Usuario bloqueado durante 15 minutos por múltiples intentos fallidos.",
                        usuario.BloqueadoHasta
                    });
                }
            ...
            var token = _tokenService.GenerarToken(usuario, roles);
        ...
        public async Task<IActionResult> Me()
        {
            ...
            if (usuario == null)
                return Unauthorized(new { mensaje = "Usuario inexistente o inactivo." });
